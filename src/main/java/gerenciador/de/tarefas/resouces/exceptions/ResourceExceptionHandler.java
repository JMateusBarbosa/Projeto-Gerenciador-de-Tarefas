package gerenciador.de.tarefas.resouces.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(UsuarioInativaException.class)
	public ResponseEntity<StandardError> pessoaInativaException(UsuarioInativaException e,
			HttpServletRequest request) {
