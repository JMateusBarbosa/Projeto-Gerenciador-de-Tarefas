...
public class User {
	...
	public User(Long codigo,
			@NotBlank(message = "Nome é obrigatório") @Size(min = 3, max = 20, message = "Nome deve ter tamnho entre 3 e 20") String nome,
			String email, String senha, Set<Permissao> permissoes) {
		super();
		this.codigo = codigo;
		this.nome = nome;
		this.email = email;
